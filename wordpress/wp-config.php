...
define('DB_USER', getenv('WORDPRESS_DB_USER') ?: 'wordpressuser');
define('DB_PASSWORD', getenv('WORDPRESS_DB_PASSWORD') ?: 'wordpresspassword');
define('DB_HOST', getenv('WORDPRESS_DB_HOST') ?: 'mysql-release-mysql');
